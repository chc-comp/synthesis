...
(assert (Start 0 -1 0 0 0 -4 -2 8))
(assert (Start 0 0 -1 0 0 -1 -1 -9))
(assert (Start 0 -1 0 0 0 1 1 -1))
(assert (Start 1 1 1 1 1 1 1 1))
(assert (Start 0 0 -1 0 0 0 0 1))
(assert (Start 0 -1 0 0 6 1 1 -1))
(assert (Start 0 0 -1 0 0 0 0 1))
(assert (Start 0 -1 0 0 0 1 1 -1))
(assert (Start 0 0 -1 0 0 -1 -6 7))
(assert (Start 0 -1 0 1 0 2 7 -7))
(assert (Start 0 0 -1 5 -1 4 -1 0))
