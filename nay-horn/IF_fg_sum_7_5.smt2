...
(assert (Start 0 -1 0 0 -2 -8 -3))
(assert (Start 0 0 -1 0 7 8 8))
(assert (Start 0 -1 0 0 -2 -3 -3))
(assert (Start 0 0 -1 0 7 8 3))
(assert (Start 0 -1 0 0 -2 -3 2))
(assert (Start 0 0 -1 0 -1 -1 4))
(assert (Start 0 -1 0 6 7 7 1))
