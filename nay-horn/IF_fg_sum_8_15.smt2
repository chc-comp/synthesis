...
(assert (Start 0 -1 0 16 0 17 -16))
(assert (Start 0 0 -1 -16 0 -2 -16))
(assert (Start 0 -1 0 16 0 17 16))
(assert (Start 0 0 -1 0 0 -2 -16))
(assert (Start 0 -1 0 0 0 -1 16))
(assert (Start 0 0 -1 0 0 16 -16))
(assert (Start 0 -1 0 0 0 -1 16))
(assert (Start 0 0 -1 0 16 17 0))
